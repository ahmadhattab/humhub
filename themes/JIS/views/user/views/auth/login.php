...
<div id="user-auth-login" class="container" style="text-align: center;">
    ...
    <h2 style="color: white">Meet Your Partner</h2>
    <br>

    <div class="panel panel-default animated bounceIn" id="login-form"
         style="max-width: 300px; margin: 0 auto 20px; text-align: left;">

        <div class="panel-heading"><?= Yii::t('UserModule.auth', '<strong>Login Member</strong>'); ?></div>
        ...
        <div class="panel-body">
            ...
            <?php else: ?>
                <?php if ($canRegister) : ?>
                    <p><?= Yii::t('UserModule.auth', "If you're already a JIS member, please login with your username/email and password."); ?></p>
            ...
            <?php if ($showLoginForm): ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <?= Html::submitButton(Yii::t('UserModule.auth', 'Login'), ['id' => 'login-button', 'data-ui-loader' => "", 'class' => 'btn btn-large btn-primary']); ?>
                    </div>
    ...
    <?php if ($canRegister && $showRegistrationForm) : ?>
        <div id="register-form"
            ...
            <div class="panel-heading"><?= Yii::t('UserModule.auth', '<strong>New Member?</strong>') ?></div>
            ...
            <div class="panel-body">
                ...
                <?php else: ?>
                    <p><?= Yii::t('UserModule.auth', "Don't have an account? Join the JIS community by entering your e-mail address."); ?></p>
                <?php endif; ?>
