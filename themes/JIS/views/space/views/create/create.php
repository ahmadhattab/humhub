...
<div class="modal-body">
    ...
    <a data-toggle="collapse" id="access-settings-link" href="#collapse-access-settings" style="font-size: 11px;">
        <i class="fa fa-caret-down"></i> <?php echo Yii::t('SpaceModule.manage', 'Advanced access settings'); ?>
    </a>

    <div id="collapse-access-settings" class="panel-collapse collapse show">
        <br>
        <div class="row">
            <div class="col-md-6">
